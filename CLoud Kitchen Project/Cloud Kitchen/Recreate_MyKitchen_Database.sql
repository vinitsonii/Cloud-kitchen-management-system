-- ===================================================================================
-- 1-CLICK CLEAN RESET & RECREATION SCRIPT FOR CLOUD KITCHEN (MYKITCHEN DATABASE)
-- Generated: 2026-08-31 23:27:55
-- Target DB: MyKitchenn.mdf
-- Description: DROPS all 11 existing tables in reverse Foreign Key order,
--              then RECREATES all 11 tables with complete schema, constraints,
--              and ingests all 146 seed & production data records cleanly.
-- ===================================================================================
...
PRINT N'Starting Complete Database Clean Reset & Recreation...';
GO

-- ===================================================================================
-- STEP 1: DROP ALL EXISTING TABLES IN REVERSE DEPENDENCY ORDER
-- ===================================================================================
PRINT N'Dropping existing tables if they exist...';
GO
...
PRINT N'All existing tables dropped successfully.';
GO
...
-- ===================================================================================
GO
/****** Object:  Database [D:\CLOUD KITCHEN\CLOUD KITCHEN PROJECT\CLOUD KITCHEN\CLOUD KITCHEN\CLOUD KITCHEN\APP_DATA\MYKITCHENN.MDF]    Script Date: 31-08-2026 14:39:09 ******/
GO
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [D:\CLOUD KITCHEN\CLOUD KITCHEN PROJECT\CLOUD KITCHEN\CLOUD KITCHEN\CLOUD KITCHEN\APP_DATA\MYKITCHENN.MDF].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
GO
GO
