<%@ Page Title="Driver Partner Login" Language="vb" AutoEventWireup="false" CodeBehind="DriverLogin.aspx.vb"
    Inherits="Cloud_Kitchen.DriverLogin" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="hero-layout">
                ...
                <div class="left-hero-content">
                    ...
                    <p class="hero-desc">
                        Your dedicated Cloud Kitchen delivery companion. Accept dispatches, navigate with 1-tap Google
                        Maps, and complete doorstep handoffs with OTP verification.
                    </p>
                ...
                <div class="right-card-wrapper">
                    <div class="login-card">
                        ...
                        <asp:Button ID="btnLogin" runat="server" Text="Sign In to Dashboard" CssClass="submit-btn"
