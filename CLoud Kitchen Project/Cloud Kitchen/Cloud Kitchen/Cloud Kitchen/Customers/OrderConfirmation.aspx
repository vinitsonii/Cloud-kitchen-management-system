<%@ Page Title="Order Confirmation" Language="vb" AutoEventWireup="false" MasterPageFile="~/Customers/Customer.Master"
    CodeBehind="OrderConfirmation.aspx.vb" Inherits="Cloud_Kitchen.OrderConfirmation" %>
        ...
        <div class="ck-confirm-card">
            ...
            <div class="ck-order-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <asp:Label ID="lblOrderStatus" runat="server" CssClass="status-badge status-pending">
                        </asp:Label>
                    </span>
                </div>
            ...
            <asp:Panel ID="pnlPendingMessage" runat="server" Visible="false">
                <div class="ck-pending-panel">
                    <p>⏳ Your order is currently <strong>Pending</strong>. We're preparing it and will update you soon!
                    </p>
                    <asp:Button ID="btnTrackOrder" runat="server" CssClass="ck-track-btn" Text="📍 Track My Order"
