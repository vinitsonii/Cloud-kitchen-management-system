...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="add-items-page">
        <!-- MODERN LIGHT-THEME HEADER CARD -->
        <div style="background: #ffffff; border-radius: 14px; padding: clamp(16px, 2.5vw, 24px); margin-bottom: 24px; box-shadow: 0 4px 20px rgba(0,0,0,0.04); border: 1px solid #e2e8f0; border-left: 6px solid #2563eb; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px 16px; width: 100%;">
            <div>
                <h1 style="font-size: clamp(1.25rem, 3.5vw, 1.75rem); font-weight: 800; color: #0f172a; margin: 0 0 4px 0; letter-spacing: -0.3px; line-height: 1.25; word-break: break-word; overflow-wrap: anywhere;">🍲 Manage Food Menu Items</h1>
                <p style="font-size: clamp(0.82rem, 1.8vw, 0.92rem); color: #64748b; margin: 0; line-height: 1.4; word-break: break-word;">Add new food items, configure pricing, availability status, categories, and ingredients recipe.</p>
            </div>
            <div style="background: #eff6ff; color: #2563eb; border: 1px solid #bfdbfe; font-size: clamp(0.78rem, 1.8vw, 0.85rem); font-weight: 700; padding: 6px 16px; border-radius: 30px; display: inline-flex; align-items: center; gap: 6px; white-space: nowrap;">
                ...
                <asp:Repeater ID="rptMenuItems3" runat="server" OnItemCommand="rptMenuItems3_ItemCommand">
                    <ItemTemplate>
                        <div class="menu-card">
                            ...
                            <div class="card-actions" style="grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 6px;">
                                ...
                                <a href='<%# "ManageInventory.aspx?m_id=" & Eval("m_id") %>' class="card-btn" style="background: #10b981; color: white; display: flex; align-items: center; justify-content: center; text-decoration: none;">🥦 Recipe</a>
